...
class Id3v2
{
    ...
    /**
     * @param  type    $TagAlter
     * @param  type    $FileAlter
     * @param  type    $ReadOnly
     * @param  type    $Compression
     * @param  type    $Encryption
     * @param  type    $GroupingIdentity
     * @param  type    $Unsynchronisation
     * @param  type    $DataLengthIndicator
     *
     * @return bool
     */
