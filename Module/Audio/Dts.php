...
class Dts extends BaseHandler
{
     ...
     * @return type
     */
    private static function bitrateLookup($index)
    {
     ...
     * @return type
     */
    private static function sampleRateLookup($index)
    {
     ...
     * @return type
     */
    private static function bitPerSampleLookup($index)
    {
     ...
     * @return int|bool
     */
    private static function numChannelsLookup($index)
    {
        switch ($index) {
            case 0:
                return 1;
     ...
     * @return type
     */
    private static function channelArrangementLookup($index)
    {
     ...
     * @return bool
     */
    private static function dialogNormalization($index, $version)
    {
        switch ($version) {
            case 7:
                return 0 - $index;
